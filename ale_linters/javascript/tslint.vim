...
function! ale_linters#javascript#tslint#Handle(buffer, lines) abort
...
function! ale_linters#javascript#tslint#GetCommand(buffer) abort
...
\   'command_callback': 'ale_linters#javascript#tslint#GetCommand',
\   'callback': 'ale_linters#javascript#tslint#Handle',
\})
